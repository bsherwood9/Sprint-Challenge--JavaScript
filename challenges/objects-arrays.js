...
//an array that returns only the universities
// const unisWithUniA = universities.filter(item => item.includes("Uni"));
// console.log(unisWithUniA);
// console.log(unisWithUniA.length);
